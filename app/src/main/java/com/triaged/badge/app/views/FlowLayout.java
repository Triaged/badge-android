...
public class FlowLayout extends ViewGroup {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for(int i = 0; i < numLines; i++) {
            ...
            for(int j = 0; j < children; j++) {
                ...
                if(lp.height == CustomLayoutParams.MATCH_PARENT) {
                    int childWidthMode = MeasureSpec.AT_MOST;
                    int childWidthSize = lineWidth;

                    if(lp.width == CustomLayoutParams.MATCH_PARENT) {
    ...
    protected ViewGroup.LayoutParams generateDefaultLayoutParams() {
        return new CustomLayoutParams(CustomLayoutParams.MATCH_PARENT, CustomLayoutParams.MATCH_PARENT);
    }
