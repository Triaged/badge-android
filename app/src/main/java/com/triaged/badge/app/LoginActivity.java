...
//                Toast.makeText(LoginActivity.this, email, Toast.LENGTH_SHORT).show();
    ...
    // ------------------------------------------------------------------
    // ------------------------------------------------------------------
    // To prevent merge drama, do not edit anything below this line on the
    // release branch EVER
    // ------------------------------------------------------------------
    ...
    /**
     * Descriptive name is to indicate that this function shouldn't
     * be called in a release apk, only the preview apk that editors
     * developers, and curators have installed.
     *
