...
public class CompanySQLiteHelper extends SQLiteOpenHelper {
    ...
    protected static final String CREATE_CONTACTS_TABLE_SQL = String.format( "create table %s (%s  integer primary key, %s text, %s text, %s text, %s text, %s text, %s text, %s text, %s text, %s text, %s integer, %s integer, %s integer, %s integer, %s integer );",
            TABLE_CONTACTS,
            COLUMN_CONTACT_ID,
